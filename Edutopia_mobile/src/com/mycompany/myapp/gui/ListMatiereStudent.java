 ...
 * @author Mrad
 */
public class ListMatiereStudent extends Form {
    Form current;
    public ListMatiereStudent(Resources res ) {
...
//          //  a.show();
//            refreshTheme();
            new ListMatiereStudent(res).show();
        });
...
//        System.out.println(c.toString());
        ...
        ArrayList<User> arraylist = SubjectService.getInstance().listTeachers();
        User u = new User();
        for (User teach : arraylist) {
            if(teach.getId()==c.getId_teacher())
                u=teach;
        }
        System.out.println(u.toString());
//        System.out.println(classe.toString());
        Label idClasseTxt = new Label("Enseignant : "+u.getName()+" "+u.getLastName(),"NewTopLine2" );
